...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: isZh ? "工具 · DeepSeek 文档" : "Tools · DeepSeek Docs",
    description: isZh
  ...
  return (
    <section className="space-y-10">
      <section id="overview" className="scroll-mt-32">
        ...
        <p className={`text-ink-soft mt-3 ${isZh ? "leading-[1.9] tracking-wide" : "leading-relaxed"}`}>
          {isZh
            ...
            : "Curated surface — see "}
          <Link
            href="https://github.com/coohu/deepseek-tui/blob/main/docs/TOOL_SURFACE.md"
            className="body-link"
          >
      ...
      <section id="lifecycle" className="scroll-mt-32">
        ...
        <Link
          href="https://github.com/coohu/deepseek-tui/blob/main/docs/TOOL_LIFECYCLE.md"
