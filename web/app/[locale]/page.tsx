...
const FALLBACK_DISPATCH_EN: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "Browse open issues", href: "https://github.com/coohu//issues", tag: "opened", blurb: "Triaged on GitHub — start with anything labelled 'good first issue'." },
    ...
    <>
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 pt-10 sm:pt-14 pb-12 grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7">
            ...
            <div className="mt-6 flex items-center gap-4 text-xs font-mono text-ink-mute flex-wrap">
              <span>{isZh ? "独立维护者 coohu" : "Maintained by coohu"}</span>
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-16">
        ...
        <p className={`mb-8 text-ink-soft max-w-2xl ${isZh ? "leading-[1.9] tracking-wide" : "text-sm leading-relaxed"}`}>
          {isZh
            ? "模型会生成文本；Agent 会留下后果。DeepSeek 把后果需要的结构放在模型外面：自我、权威、证据、工具，各在其位。"
            : "A model generates text; an agent leaves consequences. DeepSeek puts the structure for those consequences around the model: self, authority, evidence, and tools, each in its place."}
        </p>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 hairline-t hairline-b hairline-l hairline-r bg-paper">
              <div className="bg-ink text-paper px-4 py-3 flex items-center justify-between gap-4">
                <div className="font-mono text-sm uppercase tracking-widest">DeepSeek / review loop</div>
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-16">
        ...
        <div className="hairline-t hairline-b hairline-l hairline-r bg-paper p-4 sm:p-8">
          <MermaidDiagram
            label={isZh ? "DeepSeek 运作方式示意图" : "DeepSeek architecture diagram"}
            chart={
              isZh
                ? `flowchart TD
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-14">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <Link href="https://github.com/coohu/deepseek-tui/blob/main/CHANGELOG.md#0848---2026-05-31" className="inline-block mt-4 font-mono text-xs uppercase tracking-wider text-indigo hover:underline">
