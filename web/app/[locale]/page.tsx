...
const FALLBACK_DISPATCH_EN: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "Browse open issues", href: "https://github.com/coohu/deepseek-tui/issues", tag: "opened", blurb: "Triaged on GitHub — start with anything labelled 'good first issue'." },
...
const FALLBACK_DISPATCH_ZH: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "浏览开放议题", href: "https://github.com/coohu/deepseek-tui/issues", tag: "opened", blurb: "在 GitHub 上查看——从标记为 good first issue 的议题开始。" },
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 pt-10 sm:pt-14 pb-12 grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-8">
            ...
            <div className="mt-6 flex items-center gap-4 text-xs font-mono text-ink-mute flex-wrap">
              {isZh ? (
                <span>独立维护者 coohu{GITEE_ENABLED && <> · <a href="https://gitee.com/coohu/deepseek-tui" className="text-indigo hover:underline">Gitee 镜像</a></>}</span>
              ) : (
                <span>Maintained by coohu</span>
              )}
            </div>
          </div>
      ...
      <section className="bg-ink text-paper">
        <div className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-3 gap-px bg-paper/15">
            {(isZh
              ? [
                  { t: "提交议题", cn: "提 Bug 或功能建议", d: "Bug 报告、功能需求，或一个好问题。", href: "https://github.com/coohu/deepseek-tui/issues/new/choose" },
                  { t: "提交 PR", cn: "贡献代码", d: "Fork、分支、conventional commit、提交 PR。", href: "/zh/contribute" },
                  { t: "发起讨论", cn: "参与设计", d: "路线图、架构设计、任何非 Bug 的话题。", href: "https://github.com/coohu/deepseek-tui/discussions" },
                ]
              : [
                  { t: "Open an issue", cn: "提议题", d: "Bug, feature, or just a sharp question.", href: "https://github.com/coohu/deepseek-tui/issues/new/choose" },
                  { t: "Send a PR", cn: "提交合并", d: "Fork, branch, conventional commit, open PR.", href: "/contribute" },
                  { t: "Start a discussion", cn: "发起讨论", d: "Roadmap, design, anything that's not a bug.", href: "https://github.com/coohu/deepseek-tui/discussions" },
                ]
            ).map((c) => (
              <Link
                key={c.t}
