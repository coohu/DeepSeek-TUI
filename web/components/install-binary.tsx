...
const SNIPPETS: Record<Arch, string> = {
  ...
  https://github.com/coohu//releases/latest/download/deepseek-macos-arm64
chmod +x deepseek
xattr -d com.apple.quarantine deepseek 2>/dev/null || true
sudo mv deepseek /usr/local/bin/`,
  "macos-x64": `curl -fsSL -o deepseek \\
  https://github.com/coohu//releases/latest/download/deepseek-macos-x64
chmod +x deepseek
xattr -d com.apple.quarantine deepseek 2>/dev/null || true
sudo mv deepseek /usr/local/bin/`,
  "linux-x64": `curl -fsSL -o deepseek \\
  https://github.com/coohu//releases/latest/download/deepseek-linux-x64
chmod +x deepseek
sudo mv deepseek /usr/local/bin/`,
  "linux-arm64": `curl -fsSL -o deepseek \\
  https://github.com/coohu//releases/latest/download/deepseek-linux-arm64
chmod +x deepseek
sudo mv deepseek /usr/local/bin/`,
...
const VERIFY: Record<Arch, string> = {
  "macos-arm64": `curl -fsSL -O https://github.com/coohu//releases/latest/download/deepseek-artifacts-sha256.txt
shasum -a 256 -c deepseek-artifacts-sha256.txt --ignore-missing`,
  "macos-x64": `curl -fsSL -O https://github.com/coohu//releases/latest/download/deepseek-artifacts-sha256.txt
shasum -a 256 -c deepseek-artifacts-sha256.txt --ignore-missing`,
  "linux-x64": `curl -fsSL -O https://github.com/coohu//releases/latest/download/deepseek-artifacts-sha256.txt
