...
export const TRIAGE_PROMPT = `You are a community triage assistant for the  open source project (coohu/).
...
export const PR_REVIEW_PROMPT = `You are a community PR review assistant for the  open source project (coohu/).
...
export const STALE_PROMPT = `You are a community maintenance assistant for the  open source project (coohu/).
...
export const DUPES_PROMPT = `You are a community deduplication assistant for the  open source project (coohu/).
...
export const DIGEST_PROMPT = `You are the editor of a weekly digest for the  open source project (coohu/).
