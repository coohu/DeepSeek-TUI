...
export class RuntimeStatusView implements vscode.WebviewViewProvider {
  public static readonly viewType = "deepseek.runtimeStatus";
  ...
  resolveWebviewView(view: vscode.WebviewView): void {
    ...
    view.webview.onDidReceiveMessage((message: { command?: string }) => {
      if (message.command === "check") {
        ...
        void vscode.commands.executeCommand("deepseek.startRuntime");
      } else if (message.command === "terminal") {
        void vscode.commands.executeCommand("deepseek.openTerminal");
      } else if (message.command === "threads") {
        void vscode.commands.executeCommand("deepseek.refreshAgentView");
      } else if (message.command === "snapshots") {
        void vscode.commands.executeCommand("deepseek.refreshSnapshots");
      }
    });
    this.render();
  }
...
<body>
  ...
  <button data-command="terminal">Open DeepSeek Terminal</button>
