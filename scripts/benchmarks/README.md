...
Convenience runners for evaluating DeepSeek against external benchmarks.
...
- `harbor/__init__.py` — Harbor adapter for DeepSeek (Python)
- `harbor/deepseek_agent.py` — Adapter entry point
