...
;   3. Output: DeepSeekSetup.exe (in current directory)
...
!define PRODUCT_PUBLISHER "coohu"
!define PRODUCT_WEB_SITE "https://github.com/coohu/deepseek-tui"

Name "${PRODUCT_NAME} ${VERSION}"
OutFile "DeepSeekSetup.exe"
InstallDir "$LOCALAPPDATA\Programs\DeepSeek"
