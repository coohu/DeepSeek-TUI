#!/usr/bin/env bash
# EXPERIMENTAL — DigitalOcean smoke-lab provisioning for the DeepSeek
...
#
# Tunables (env):
#   DROPLET_NAME    default deepseek-smoke
...
DROPLET_NAME="${DROPLET_NAME:-deepseek-smoke}"
