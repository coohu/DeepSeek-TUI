...
//! Priority: WHALE.md > AGENTS.md > .claude/instructions.md > CLAUDE.md > .deepseek/instructions.md > .deepseek/instructions.md
...
/// provide compatibility; `.deepseek/` is the new config directory.
