...
const PROFILE_DIR: &str = ".deepseek/agents";
...
impl FleetSetupSnapshot {
    ...
    pub fn from_app(app: &App, config: &Config) -> Self {
        ...
        let fleet_spawn_depth = config
            ...
            .unwrap_or_else(|| deepseek_config::FleetExecConfig::default().max_spawn_depth)
        ...
        FleetSetupLane {
            ...
            rows: vec![
                ...
                FleetSetupRow::new(
                    ...
                    format!("ceiling {}", deepseek_config::MAX_SPAWN_DEPTH_CEILING),
                )
                .tone(RowTone::Ready),
                FleetSetupRow::new(
                    "slot grid",
...
fn profile_authoring_prompt(
    ...
    format!(
        "Create a safe DeepSeek Fleet agent profile file for this workspace.\n\n\
...
mod tests {
    ...
    fn snapshot() -> FleetSetupSnapshot {
        FleetSetupSnapshot {
            workspace: PathBuf::from("/tmp/deepseek-test-workspace"),
    ...
    fn enter_inserts_profile_authoring_prompt() {
        ...
        match action {
            ViewAction::EmitAndClose(ViewEvent::CommandPaletteSelected {
                ...
                assert!(text.contains("Target path: .deepseek/agents/manager.toml"));
    ...
    fn selected_role_and_model_class_drive_generated_profile() {
        ...
        assert!(
            prompt.contains("Target path: .deepseek/agents/builder.toml"),
