...
use deepseek_config::catalog::{CatalogOffering, CatalogSnapshot};
use deepseek_config::provider::WireFormat;
use deepseek_config::route::{
...
fn bundled_reasoning_catalog() -> &'static CatalogSnapshot {
    ...
    CATALOG.get_or_init(|| CatalogSnapshot {
        ...
        offerings: deepseek_config::catalog::bundled_catalog_offerings(),
    })
}
