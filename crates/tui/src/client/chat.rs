...
const SYSTEM_PROMPT_DUMP_ENV: &str = "DEEPSEEK_DUMP_SYSTEM_PROMPT";
const SYSTEM_PROMPT_DUMP_BEGIN: &str = "<<<DEEPSEEK_SYSTEM_PROMPT_BEGIN>>>";
const SYSTEM_PROMPT_DUMP_END: &str = "<<<DEEPSEEK_SYSTEM_PROMPT_END>>>";
