...
use deepseek_config::route::ReadyRouteCandidate;
...
mod tests {
    ...
    async fn static_rows_survive_a_live_refresh_failure() {
        ...
        let fresh_live: Vec<CatalogOffering> = cache
            ...
            .unwrap_or_default();
        let snapshot = deepseek_config::catalog::CatalogCompiler::new()
