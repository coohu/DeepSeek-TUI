...
pub struct FleetManager {
    ...
    exec_config: deepseek_config::FleetExecConfig,
...
impl FleetManager {
    pub fn open(workspace: impl AsRef<Path>) -> Result<Self> {
        ...
        Ok(Self {
            ...
            exec_config: deepseek_config::FleetExecConfig::default(),
    ...
    pub fn with_exec_config(mut self, exec_config: deepseek_config::FleetExecConfig) -> Self {
    ...
    pub async fn run_to_completion(
        ...
        loop {
            ...
            self.drive_executor_tick(run_id, executor, deepseek_binary, model)?;
            self.refresh_run_status(run_id)?;
    ...
    pub fn drive_executor_tick(
        ...
        report.started += self.start_leased_workers(run_id, executor, deepseek_binary, model)?;
    ...
    fn write_log_artifact(
        ...
        let rel_path = PathBuf::from(".deepseek")
            .join("fleet")
...
mod tests {
    ...
    fn fake_codewhale(dir: &TempDir, body: &str) -> PathBuf {
        ...
        let path = dir.path().join("fake-deepseek");
        ...
        let tasks = vec![
            FleetTaskSpec {
                ...
                workspace: Some(FleetWorkspaceRequirements {
                    ...
                    writable_paths: vec![PathBuf::from(".deepseek/fleet")],
