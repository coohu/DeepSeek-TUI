...
use super::{
    ...
    DEFAULT_SGLANG_BASE_URL, DEFAULT_SGLANG_MODEL, DEFAULT_SHENGSUANYUN_BASE_URL,
    DEFAULT_SHENGSUANYUN_MODEL, DEFAULT_SILICONFLOW_BASE_URL, DEFAULT_SILICONFLOW_CN_BASE_URL,
...
provider!(
    ...
    ["SHENGSUANYUN_API_KEY", "SSY_API_KEY"],
    "shengsuanyun",
    aliases: ["shengsuanyun", "ssy"]
);
