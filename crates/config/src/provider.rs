...
use super::{
    ...
    DEFAULT_SHENGSUANYUN_BASE_URL, DEFAULT_SHENGSUANYUN_MODEL, DEFAULT_SILICONFLOW_BASE_URL,
    DEFAULT_SILICONFLOW_CN_BASE_URL, DEFAULT_SILICONFLOW_MODEL, DEFAULT_VLLM_BASE_URL,
    DEFAULT_VLLM_MODEL, DEFAULT_VOLCENGINE_BASE_URL, DEFAULT_VOLCENGINE_MODEL,
    DEFAULT_WANJIE_ARK_BASE_URL, DEFAULT_WANJIE_ARK_MODEL, DEFAULT_XIAOMI_MIMO_BASE_URL,
    DEFAULT_XIAOMI_MIMO_MODEL, ProviderKind,
};
...
provider!(
    ...
    ShengSuanYun,
    "Shengsuanyun",
    DEFAULT_SHENGSUANYUN_BASE_URL,
    DEFAULT_SHENGSUANYUN_MODEL,
...
static SHENGSUANYUN: Shengsuanyun = Shengsuanyun;
