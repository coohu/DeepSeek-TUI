...
//!
//! Models.dev is the upstream taxonomy DeepSeek should use for model facts,
...
//! `base_model` link. DeepSeek must preserve that distinction instead of
...
pub struct ModelsDevProviderModel {
    ...
    #[serde(default)]
    pub family: Option<String>,
    /// Whether this is the provider's default model in a DeepSeek snapshot.
...
/// Models.dev row specifies a richer tiering object in fields DeepSeek does
/// not yet model.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Default)]
