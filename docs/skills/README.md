...
GitHub-stewardship and release-QA workflows for maintaining DeepSeek, codified as
`SKILL.md` skills (same format Claude Code and DeepSeek both load). They encode the
...
- **DeepSeek:** copy into DeepSeek's `skills_dir` (e.g. `~/.deepseek/skills/`), or bundle
