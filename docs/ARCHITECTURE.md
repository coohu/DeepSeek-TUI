...
This document provides an overview of the deepseek architecture for developers and contributors.
...
- `~/.deepseek/config.toml` - Main configuration (`~/.deepseek/config.toml` is still read as a legacy fallback)
