...
The vision is at risk of being lost between point releases. DeepSeek is
...
| `/rules` | Repo guidance |
| `.deepseek/constitution.json` | Repo constitution: checked-in **local law** |
...
base myth / global Constitution
  -> repo constitution (.deepseek/constitution.json)
  -> task packet
  -> runtime policy
```
...
/context
  ...
  repo-constitution ▸ .deepseek/constitution.json (4 KB) [view]
