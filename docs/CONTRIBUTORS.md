...
DeepSeek is built in the open with a growing community of contributors. Every
...
[GitHub contributors page](https://github.com/coohu/deepseek-tui/graphs/contributors),
[`AUTHOR_MAP`](https://github.com/coohu/deepseek-tui/blob/main/.github/AUTHOR_MAP),
...
- **[OpenWarp](https://github.com/zerx-lab/warp)** — for prioritizing deepseek support and collaborating on a better terminal-agent experience.
...
- **[noaft](https://github.com/noaft)** — `/links` provider docs fallback
  update, including the current DeepSeek docs URL and a Baidu Qianfan docs
  link (#3621, harvested)
...
- **[nightt5879](https://github.com/nightt5879)** — keep the onboarding marker in
  the deepseek home view (#3302) and branch-hygiene check hardening (#3348)
...
sibling), added TOML comment preservation and the DeepSeek-only skill discovery
...
- **[nightt5879](https://github.com/nightt5879)** — DeepSeek-only skill discovery
  gate (`[skills].scan_deepseek_only`) ignoring cross-tool directories (#3296) and
