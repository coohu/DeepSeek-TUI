...
1. `cargo test -p deepseek-config hotbar -- --nocapture`
2. `cargo test -p deepseek-tui --bin deepseek-tui --locked hotbar::actions -- --nocapture`
3. `cargo test -p deepseek-tui --bin deepseek-tui --locked hotbar_setup -- --nocapture`
4. `cargo test -p deepseek-tui --bin deepseek-tui --locked hotbar_panel -- --nocapture`
5. `cargo test -p deepseek-tui --bin deepseek-tui --locked hotbar_alt_digit -- --nocapture`
6. `cargo test -p deepseek-tui --bin deepseek-tui --locked hotbar_dispatch -- --nocapture`
