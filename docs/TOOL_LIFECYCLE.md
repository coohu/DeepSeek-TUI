...
All file:line citations are against the verified tree at the current DeepSeek
...
DeepSeek ships a large native tool surface. The first-turn *active* partition
